...
class CoolPico(Renderer):
    ...
    def changed(self, rjvsyr):
        ...
        if self.instance:
            ...
            if not nlqmqs:
                nlqmqs = 'skin_default/picon_default.png'
...
vzxowj = ('/coolpicon/', '/usr/share/enigma2/picon/', '/media/cf/picon/', '/media/ba/picon/', '/media/meoboot/picon/', '/media/hdd/picon/', '/universe/', '/media/usb/picon/', '/picon/')
...
def findCoolPicon(zlypjp = None, zrlpzx = None, NOPICON = None):
    if zlypjp:
    ...
    if zrlpzx:
        ...
        if fileExists(resolveFilename(SCOPE_CURRENT_SKIN, 'picon_default.png')):
            return resolveFilename(SCOPE_CURRENT_SKIN, 'picon_default.png')
        if fileExists(resolveFilename(SCOPE_SKIN_IMAGE, 'skin_default/picon_default.png')):
            return resolveFilename(SCOPE_SKIN_IMAGE, 'skin_default/picon_default.png')
        if fileExists('/usr/share/enigma2/picon_default.png'):
            return '/usr/share/enigma2/picon_default.png'
        if fileExists('/usr/share/enigma2/picon/picon_default.png'):
            return '/usr/share/enigma2/picon/picon_default.png'
        if fileExists('/media/ba/picon/picon_default.png'):
            return '/media/ba/picon/picon_default.png'
        if fileExists('/media/meoboot/picon/picon_default.png'):
            return '/media/meoboot/picon/picon_default.png'
        if fileExists('/media/hdd/picon/picon_default.png'):
            return '/media/hdd/picon/picon_default.png'
        if fileExists('/media/sda1/picon/picon_default.png'):
            return '/media/sda1/picon/picon_default.png'
        if fileExists('/media/sdb1/picon/picon_default.png'):
            return '/media/sdb1/picon/picon_default.png'
        if fileExists('/media/usb/picon/picon_default.png'):
            return '/media/usb/picon/picon_default.png'
        if fileExists('/universe/picon/picon_default.png'):
            return '/universe/picon/picon_default.png'
        return ''
